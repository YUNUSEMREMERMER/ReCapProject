...
namespace Business.Constants
{
    public static class Messages
    {
        ...
        public static string ImageLimitError = "Resim Limiti aşıldı";
        public static string ImageFormatError = "resim format hatası !";
        public static string ImageUploadSuccess = "resim başarıyla yüklendi !";
        public static string CarImageNotFound = "resim bulunamadı !";
        public static string ImageDeleteSuccess = "resim başarıyla silindi !";
        public static string FileTypeInValid = "resim doğrulanamadı !";
    }
}
